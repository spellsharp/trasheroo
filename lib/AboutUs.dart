...
class AboutUs extends StatelessWidget {
  ...
  _launchKarti() async {
    Uri _url = Uri.parse('https://github.com/QuantuM410');
  ...
  _launchSharan() async {
    Uri _url = Uri.parse('https://github.com/spellsharp');
    if (await launchUrl(_url)) {
      await launchUrl(_url);
    } else {
      throw 'Could not launch $_url';
    ...
    return SingleChildScrollView(
      child: Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Padding(
            padding: const EdgeInsets.only(left: 40.0, right: 25.0, top: 25.0),
          ...
          Padding(
            padding: const EdgeInsets.only(top: 38.0, left: 18.0, right: 18.0),
            child: Container(
                height: 2,
                decoration: BoxDecoration(
